...
const Main = () => {
  return (
    <div className="divgrid">
      ...
      <div className="item"></div>
      <div className="item span3 cblack text-justify font12">
        <p>
          <big>
            <center>
        ...
        providing real-time data on the number of people passing by. Mounted on
        the door jamb or walkway opening, it ensures that anyone in front of the
        sensor is accurately counted. Say goodbye to the days of "Last person
        shut-off the lights. signs."
      </div>
